...
* the operator represented by the current token. Add a new node as the right child of the current
* node and descend to the right child.
* If the current token is a number, set the root value of the current node to the number and return
* to the parent.
